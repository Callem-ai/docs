...
The **Sustainability** tab provides environmental impact metrics for your voice AI operations. It tracks CO2 emissions and energy consumption broken down by AI component (LLM, TTS, STT).

See the dedicated [Sustainability](/monitor/sustainability) page for full details on KPIs, calculation methodology, and CSRD compliance.
