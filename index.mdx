...
Callem Studio is a comprehensive platform for building, deploying, and monitoring **AI-powered voice agents**. Design conversational workflows, connect agents to phone channels, launch outbound campaigns, and track performance — all from a single interface.
...
<CardGroup cols={2}>
  <Card title="Channels" icon="phone" href="/deploy/channels">
    Assign phone numbers to agents, configure SIP trunking, and manage inbound/outbound routing.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Analytics" icon="chart-mixed" href="/monitor/analytics">
    Visualize call volumes, durations, success rates, and custom metrics with interactive dashboards.
  </Card>
